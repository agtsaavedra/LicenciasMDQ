...
<body>
	<header>
		...
		<center>
		<h1> <font color="white">Datos Cargados Correctamente </font><h1>
<font color="white">
	 <form action="registro_persona.php" method="POST">
      ...
      <font color="white" size="3">Ingrese la fecha de nacimiento</font> <br> <input name="fecha" type="date" placeholder="Ingrese fecha"> <br> <br>
...
<font color="white">¿Desea Cargar Otra Persona?</font>
