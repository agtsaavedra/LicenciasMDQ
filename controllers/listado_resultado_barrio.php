...
$query1 = "SELECT COUNT(b.id_barrio) as cantidad, barrio from resultados r INNER JOIN turnos t ON t.id_turnos = r.id_turnos INNER JOIN personas p ON p.dni_personas = r.dni_personas INNER JOIN barrios b ON b.id_barrio = p.id_barrio WHERE r.resultado='$resultadox'";
